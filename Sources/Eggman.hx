...
class Eggman {
	...
	private function drawObject(g: Graphics, time: Float, texture: Image, normals: Image, x: Float, y: Float, w: Float, h: Float, mirror: Bool, z: Float) {
		...
		g.setTexture(partsProgram.getTextureUnit("textex"), texture);
		g.setTextureParameters(partsProgram.getTextureUnit("textex"), TextureAddressing.Clamp, TextureAddressing.Clamp, TextureFilter.LinearFilter, TextureFilter.LinearFilter, MipMapFilter.NoMipFilter);
	...
	private function drawBody(g: Graphics, time: Float, xoffset: Float): Void {
		...
		g.setTexture(bodyProgram.getTextureUnit("textex"), bodyTexture);
		g.setTextureParameters(partsProgram.getTextureUnit("textex"), TextureAddressing.Repeat, TextureAddressing.Repeat, TextureFilter.LinearFilter, TextureFilter.LinearFilter, MipMapFilter.NoMipFilter);
